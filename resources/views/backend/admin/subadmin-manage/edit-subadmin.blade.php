...
@section('toproute')
    <div class="row mb-2" style="box-shadow: rgba(100, 100, 111, 0.2) 0px 7px 29px 0px; padding: 8px; background-color:#fff">
        <div class="col-md-12 d-flex justify-content-between">
            <h4 class="m-0">Edit Sub admin </h4>
            <a href="{{route('subadmin.manage')}}" class="btn btn-outline-primary">Manage Sub admin </a>
        </div>
    </div>
@endsection
...
@section('homesection')
        ...
        <div class="col-md-12 order-2 order-md-1">
            <div class="card card-outline card-primary">
                <div class="card-body">
                    ...
                    @endif
                    <form action="{{ route('admin.update.subadmin') }}" method="post" enctype="multipart/form-data" id="subadminEdit">
                        @csrf
                        <div class="form-group row">
                            ...
                            <div class="col-md-4 my-2">
                                ...
                                <select name="subadmintype_id" id="subadminTypeId" class="form-control" id="">
                                        <option disabled>Select Sub admin Type</option>
                            ...
                            <div class="col-md-4 my-2">
                                ...
                                <select name="gender" id="gender" class="form-control @error('gender') is-invalid border border-danger @enderror">
    ...
    <script>
        document.forms['subadminEdit'].elements['subadminTypeId'].value = {{$user->subadmintype_id}};

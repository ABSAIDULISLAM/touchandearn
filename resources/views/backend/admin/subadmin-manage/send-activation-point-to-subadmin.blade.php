            ...
            <div class="card card-outline card-primary">
                <div class="card-body">
                    ...
                    @endif
                        ...
                        <form id="searchFormforsubadmin" action="{{route('admin.subadmin-id.check')}}" method="post" >
                            @csrf
                            <div class="card">
                                <div class="col-md-8 m-auto">
                                    <div class="form-group row">
                                        <div class="col-md-9">
                                            <input type="number" name="subadmin_id" class="form-control @error('subadmin_id') is-invalid border border-danger @enderror" value="{{old('student_id')}}" placeholder="Enter Here Student Id" required>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <form action="{{route('admin.send-activation-point-to-subamdin')}}" method="post">
                                    @csrf
                                    <div class="form-group row">
